...
public class PasswordActivity extends AppCompatActivity {
    ...
    private EditText passweordEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passweordEmail = (EditText) findViewById(R.id.etPasswordEmail);
        ...
        resetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String useremail = passweordEmail.getText().toString().trim();
                    ...
                    firebaseAuth.sendPasswordResetEmail(useremail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                finish();
                                startActivity(new Intent(PasswordActivity.this, MainpageActivity.class));
                            }else{
